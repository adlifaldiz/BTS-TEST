...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Toast.makeText(LoginActivity.this, "Learn More", Toast.LENGTH_SHORT).show();
            }
        ...
        passwordLogin.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (passwordInput.equals("")){
                    ...
                    textErrorPasswordLogin.setVisibility(View.GONE);
                    textErrorPasswordLogin.setText("");
                }
            }
        });
    ...
    private boolean validatePassword() {
        ...
        if (passwordInput.isEmpty()) {
            textErrorPasswordLogin.setText("Password can't be empty");
            textErrorPasswordLogin.setVisibility(View.VISIBLE);
            return false;
        } else if (passwordInput.length()<8){
            textErrorPasswordLogin.setText("Password minimum 8 character");
            textErrorPasswordLogin.setVisibility(View.VISIBLE);
            return false;
        } else {
    ...
    private boolean validateEmail(EditText emailLogin) {
        ...
        if (emailInput.isEmpty()) {
            textErrorEmailLogin.setText("Email can't be empty");
        ...
        //incase untuk pattern email address
            ...
            textErrorEmailLogin.setText("Incorrect format email");
            textErrorEmailLogin.setVisibility(View.VISIBLE);
